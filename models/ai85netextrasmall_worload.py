...
class AI85NetExtraSmallWorkload(nn.Module):
    """
    Minimal CNN for minimum energy per inference for MNIST
    """
    def __init__(self, num_classes=10, num_channels=1, dimensions=(28, 14),
...
def ai85netextrasmall_workload(pretrained=False, **kwargs):
    """
    Constructs a AI85NetExtraSmall_custom model.
    """
    assert not pretrained
    return AI85NetExtraSmallWorkload(**kwargs)


models = [
    {
        'name': 'ai85netextrasmall_workload',
        'min_input': 1,
        'dim': 2,
    },
]
